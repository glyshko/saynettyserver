...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { acceskey: @login.acceskey, channelid: @login.channelid, ipadress: @login.ipadress, port: @login.port, state: @login.state }
    end
  ...
  test "should update login" do
    put :update, id: @login, login: { acceskey: @login.acceskey, channelid: @login.channelid, ipadress: @login.ipadress, port: @login.port, state: @login.state }
    assert_redirected_to login_path(assigns(:login))
  end
